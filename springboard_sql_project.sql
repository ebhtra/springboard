...
SELECT name AS "No Member Fee"
FROM country_club.Facilities
WHERE membercost = 0

/* Q2: How many facilities do not charge a fee to members? */

SELECT COUNT( * ) AS "Free Places for Members"
FROM country_club.Facilities
WHERE membercost = 0
...
SELECT DISTINCT CONCAT( firstname, ' ', surname ) AS member, f.name AS court
...
SELECT f.name as facility, CONCAT( m.firstname, ' ', m.surname ) AS person,
CASE WHEN b.memid =0
